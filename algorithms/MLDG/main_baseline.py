...
def main():
    ...
    # how to use: python3 this_file.py train
    ...
    train_arg_parser.add_argument("--batch_size", type=int,
                                  default=128,
                                  help="batch size for training, default is 64")
    train_arg_parser.add_argument("--num_classes", type=int,
                                  default=10,
                                  help="number of classes")
    train_arg_parser.add_argument("--step_size", type=int,
                                  default=1,
    ...
    train_arg_parser.add_argument("--lr", type=float,
                                  default=0.0001,
                                  help='learning rate of the model')
    train_arg_parser.add_argument("--weight_decay", type=float,
                                  default=0.00005,
                                  help='weight decay')
    train_arg_parser.add_argument("--momentum", type=float,
                                  default=0.9,
                                  help='momentum')
    train_arg_parser.add_argument("--logs", type=str,
                                  default='logs/',
                                  help='logs folder to write log')
    train_arg_parser.add_argument("--model_path", type=str,
                                  default='./models',
                                  help='folder for saving model')
    train_arg_parser.add_argument("--state_dict", type=str,
                                  default='',
                                  help='model of pre trained')
    train_arg_parser.add_argument("--data_root", type=str,
                                  default='./data',
                                  help='folder root of the data')
    train_arg_parser.add_argument("--debug", type=bool,
                                  default=False,
